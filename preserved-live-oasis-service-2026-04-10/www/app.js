...
function initMasterSchedule() {
  ...
  const clients = [
    ...
    { name: "Gcpsl", address: "Coral Bay Village", tech: "Service - Donald", serviceDays: ["Friday"] },
    { name: "Gcpsl", address: "Coral Bay Village, Shamrock Rd", tech: "Service - Donald", serviceDays: ["Monday"] },
    { name: "Gcpsl", address: "Gypsy 1514 Rum Point Dr", tech: "Service - Donald", serviceDays: ["Wednesday"] },
    { name: "Gcpsl", address: "Kai Vista, Rum Point Dr", tech: "Service - Donald", serviceDays: ["Wednesday"] },
    ...
    { name: "Gcpsl", address: "Queens Highway, Bella Rocca", tech: "Service - Donald", serviceDays: ["Wednesday"] },
    { name: "Gcpsl", address: "Rip Kai, Rum Point Drive", tech: "Service - Donald", serviceDays: ["Thursday"] },
    { name: "Gcpsl", address: "Sea 2 Inity, Kiabo,", tech: "Service - Donald", serviceDays: ["Wednesday"] },
    { name: "Gcpsl", address: "Sea View, South Church Street, (Aw)", tech: "Service - Kadeem", serviceDays: ["Friday", "Tuesday"] },
    { name: "Gcpsl", address: "Sunrays, Sand Cay Rd", tech: "Service - Donald", serviceDays: ["Thursday"] },
    ...
    { name: "Reg Williams", address: "Cliff House", tech: "Service - Donald", serviceDays: ["Wednesday"] },
